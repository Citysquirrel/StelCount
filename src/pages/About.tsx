...
export function About() {
	...
	return (
		<Stack padding="12px" minHeight="100%">
			<Spacing size={48} />
			<Section heading="ABOUT" fontSize="3xl" fontWeight={"500"}>
			...
			<Spacing size={48} />
			<Section heading="NOTICE" fontSize="3xl">
				<Text>
			...
			<Spacing size={48} />
			<Section heading="CONTACT" fontSize="3xl">
...
function Section({ heading, children, ...props }: SectionProps) {
	return (
		<Box as="section" textAlign={"center"} {...props}>
			<Heading marginBottom={"16px"}>{heading}</Heading>
			{children}
		</Box>
	);
}
